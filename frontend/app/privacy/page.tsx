  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none space-y-8">
        {/* Responsible Party */}
        <section>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Responsible Party</h2>
          <p className="text-gray-700 leading-relaxed">
            This website is operated privately and without commercial purposes.
          </p>
          <p className="text-gray-700 leading-relaxed mt-2">
            Responsible for data processing: <a href="mailto:hoodinformatik@gmail.com" className="text-blue-600 hover:underline">hoodinformatik@gmail.com</a>
          </p>
        </section>

        {/* General Information */}
        <section>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">General Information on Data Processing</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        {/* Cloudflare */}
        <section>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Use of Cloudflare</h2>
        ...
        {/* Rights */}
        <section>
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Rights of Data Subjects</h2>
          <p className="text-gray-700 leading-relaxed">
